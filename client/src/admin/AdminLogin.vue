          ...
          <div class="container">
            ...
            <div style="margin-bottom: 0.1vh">
              ...
              <label for="remember-me"
                     style="font-size: 12px; margin-left: 5px; vertical-align: middle; padding-bottom: 0.2vh">Запомнить
                меня</label>
            </div>
      ...
      axios.post("/api/admin/login", {
        ...
        if (response.data["access_token"] && response.data["refresh_token"]) {
          ...
          if (response.data["role"] === "admin") {
            window.location.href = "/admin/new_applications"
          } else if (response.data["role"] === "manager") {
            window.location.href = "/admin/new_applications"  // Change to actual
          }
        }
